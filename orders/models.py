...
class OrderitemQueryset(models.QuerySet):
    def total_price(self):
        return sum(self.products_price() for cart in self)
...
class Order(models.Model):
    ...
    def __str__(self):
        return f"Заказ No {self.pk} | Покупатель {self.user.first_name} {self.user.last_name}"
...
class OrderItem(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Проданныe товар"
    ...
    def __str__(self):
        return f"Товар {self.name} | Заказ No {self.order.pk}"
